...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function geshouDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/geshouDel.action?id="+id;
               }
           }
           
           function geshouAdd()
           {
                 var url="<%=path %>/admin/geshou/geshouAdd.jsp";
	...
	<body style="margin: 12px;">
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align="center" bgcolor="#FAFAF1" style="height: 34px;">
					...
					<td bgcolor="#FFFFFF" align="center">
					    <s:property value="#geshou.chusheng"/>
					</td>
					
					
					<td bgcolor="#FFFFFF" align="center">
					    <s:property value="#geshou.jianjie"/>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center">
						<input type="button" value="删除" onclick="geshouDel(<s:property value="#geshou.id"/>)"/>
					</td>
				</tr>
				</s:iterator>
			</table>
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 11px;">
			  <tr>
			    <td>
			        <input type="button" value="添加歌手" style="width: 120px;" onclick="geshouAdd()" />
			    </td>
			  </tr>
		    </table>
